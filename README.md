...
Ошибки возвращаются реальным HTTP-статусом (400/403/413/415/422/502/503/504/500), а не 200 с
ошибкой внутри (403 — недопустимый браузерный `Origin`, см. docs.md §7). Тело большинства ошибок —
`{"error": "..."}`; есть два задокументированных исключения со стандартным для FastAPI/Starlette
телом `{"detail": ...}` (422-валидация и превышение лимита полей/файлов multipart-формы) — см.
docs.md §3. Подробнее, включая примеры запросов/ответов, лимиты и политику безопасности URL:
[docs.md](docs.md).
